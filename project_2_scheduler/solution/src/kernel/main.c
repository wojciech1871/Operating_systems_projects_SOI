...
/* Start the ball rolling. */
  ...
  rp->group_proc = GROUP_A;
  rp->base_priority = MIN_PRI;
  rp->current_priority = MIN_PRI;
  ...
  proc[NR_TASKS+INIT_PROC_NR].group_proc = GROUP_A;
  proc[NR_TASKS+INIT_PROC_NR].base_priority = MIN_PRI;
  proc[NR_TASKS+INIT_PROC_NR].current_priority = MIN_PRI;
